            ...
            delete: function() {
                ...
                if (-1 !== this.id) {
                    ...
                    c.a.CreateModal({
                        ...
                        t.ignoreControls = !1, "Apagar" === e.title && (t.$phoneAPI.deleteContact(t.id), history.back())
                    })
                } else history.back()
            }
        }),
        ...
        methods: i()({}, n.i(r.a)(["setMessageRead", "sendMessage", "deleteMessage"]), {
            ...
            onRight: function() {
                ...
                !0 !== this.ignoreControls && -1 === this.selectMessage && (this.ignoreControls = !0, h.a.CreateModal({
                    ...
                    "Enviar GPS Coord" === e.title && t.sendMessage({
                        phoneNumber: t.phoneNumber,
                        message: "%pos%"
                    }), t.ignoreControls = !1
                }))
            ...
            resetPhone: function(t, e) {
                ...
                if ("Cancelar" !== e.title) {
                    ...
                    d.a.CreateModal({
                        ...
                        n.ignoreControls = !1, "FORMATAR" === t.title && n.$phoneAPI.deleteALL()
                    })
                }
            }
        }),
