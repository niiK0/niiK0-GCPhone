...
Citizen.CreateThread(function()
	...
	while true do
		...
		if phone == true then
			ESX.ShowNotification('Pressiona ~b~"Seta para cima" ~s~para trocar para o modo ~y~selfie~s~.')
			ESX.ShowNotification('Pressiona ~b~"ESC" ~s~ou ~b~"SPACE" ~s~para ~r~sair do ~s~ modo ~y~selfie~s~.')
			ESX.ShowNotification('Pressiona ~b~"Clique Esquerdo" ~s~para ~g~tirar ~s~uma ~y~selfie~s~.')
